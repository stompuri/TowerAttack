...
namespace TA
{
	class StateMidMenu : public virtual TA::GameState
	{
	public:
		void Init();
		void Cleanup();
		...
		static StateMidMenu* Instance() {
			return &m_MenuState;
		}

		enum MenuResult { Nothing, Exit, Mainmenu, Play }; // Different actions when clicking around main menu
		struct MenuItem
		{
		public:
	...
	private:
		static StateMidMenu m_MenuState;
